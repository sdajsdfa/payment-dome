...
<div class="container">
    ...
    <form method="post" action=".." id="form1"
        ...
        &nbsp;&nbsp;LocalTime:<span id="localtime">2022-12-02 10:51:28</span>
    </form>
</div>
...
<div class="jsfylayer">
    ...
    <div class="jsfybox">
        ...
        <div class="jsfytype" id="jsfya"><i></i> <span data-gid="auto" data-id="auto">自动识别</span> <span data-gid="zh"
                                                                                                        data-id="zh">中文</span>
            <span data-gid="en" data-id="en">英语</span> <span data-gid="ja" data-id="jp">日语</span> <span data-gid="ko"
                                                                                                        data-id="kor">韩语</span>
        ...
        <div class="jsfytype" id="jsfyb"><i></i> <span data-gid="en" data-id="en">英语</span> <span data-gid="zh"
                                                                                                  data-id="zh">中文</span>
            <span data-gid="ja" data-id="jp">日语</span> <span data-gid="ko" data-id="kor">韩语</span> <span data-gid="fr"
                                                                                                         data-id="fra">法语</span>
            <span data-gid="de" data-id="de">德语</span> <span data-gid="es" data-id="spa">西班牙语</span> <span data-gid="it"
                                                                                                           data-id="it">意大利语</span>
            <span data-gid="pt" data-id="pt">葡萄牙语</span> <span data-gid="vi" data-id="vie">越南语</span> <span
