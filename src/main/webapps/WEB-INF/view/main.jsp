...
<div class="header">
    ...
    <div class="dl-log">
        欢迎您，<span class="dl-log-user">root</span><a href="logout" title="退出系统" class="dl-log-quit">[退出]</a>
    </div>
</div>
<div class="content">
